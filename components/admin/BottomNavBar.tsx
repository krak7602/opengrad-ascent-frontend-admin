  ...
  return (
    <div className="fixed bottom-0 left-0 z-10 flex w-full items-center justify-around border-t bg-gray-100 p-2 dark:border-gray-800 dark:bg-gray-950 lg:hidden">
      <Link
        ...
        href="/dashboard"
      >
        <Home03Icon className="h-6 w-6 text-gray-500 transition-colors hover:text-gray-900  dark:text-gray-400 dark:hover:text-gray-50" />
      </Link>
      <Link
        className="flex flex-col items-center gap-1 text-gray-500 transition-colors hover:text-gray-900  dark:text-gray-400 dark:hover:text-gray-50"
        href="/cohorts"
      >
        <UserGroupIcon className="h-6 w-6 text-gray-500 transition-colors hover:text-gray-900  dark:text-gray-400 dark:hover:text-gray-50" />
      </Link>
      <Link
        className="flex flex-col items-center gap-1 text-gray-500 transition-colors hover:text-gray-900  dark:text-gray-400 dark:hover:text-gray-50"
        href="/feedback"
      >
        <Comment01Icon className="h-6 w-6 text-gray-500 transition-colors hover:text-gray-900  dark:text-gray-400 dark:hover:text-gray-50" />
      </Link>
      <Link
        className="flex flex-col items-center gap-1 text-gray-500 transition-colors hover:text-gray-900  dark:text-gray-400 dark:hover:text-gray-50"
        href="/settings"
